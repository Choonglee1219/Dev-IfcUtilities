...
def inject_georeferencing_endpoint(
    ...
    rotationAngle: Optional[float] = Form(None),
    xAxisAbscissa: Optional[float] = Form(None),
    xAxisOrdinate: Optional[float] = Form(None),
    ...
    try:
        ...
        georeferencing.inject_geographic_crs(
            ...
            xaxis_abscissa=xAxisAbscissa,
            xaxis_ordinate=xAxisOrdinate,
            crs_name=crsName,
